...
public class BackupView extends RelativeLayout {
    ...
    */
    public void setBackup(Backup backup, String sizeString,
        ...
        TextView version_and_size = (TextView) findViewById(R.id.version_and_size);
        version_and_size.setText(
                getContext().getString(R.string.version_text, backup.versionName) +
                " - " + sizeString);
